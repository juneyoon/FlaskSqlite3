...
def editMenuItem(cooking_id):
    if request.method == 'POST':
      ...
      return render_template('editmenuitem.html', cooking_id=cooking_id)    

@app.route('/menu/<int:cooking_id>/<int:menu_id>/delete', methods=['GET','POST'])
def deleteMenuItem(cooking_id, menu_id):
